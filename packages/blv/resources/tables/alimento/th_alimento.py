...
class View(BaseComponent):
    ...
    def th_struct(self,struct):
        ...
        r.fieldcell('id')
        r.fieldcell('id_v_40')
        r.fieldcell('id_swissfir')
        r.fieldcell('nome')
        r.fieldcell('sinonimi')
        r.fieldcell('categoria')
        r.fieldcell('densita')
        r.fieldcell('unita_di_riferimento')
...
class Form(BaseComponent):
    ...
    def th_form(self, form):
        ...
        fb.field('id' )
        fb.field('id_v_40' )
        fb.field('id_swissfir' )
        fb.field('nome' )
        fb.field('sinonimi' )
        fb.field('categoria' )
        fb.field('densita' )
        fb.field('unita_di_riferimento' )
