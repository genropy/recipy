...
class Table(object):
    def config_db(self,pkg):
        ...
        tbl.column('ingrediente_id',size='21',name_long='Ingrediente').relation('rcpy.ingrediente.id',relation_name='ricette', mode='foreignkey', onDelete='raise')
        tbl.column('qt',dtype='N',name_long='Quantità')
        tbl.column('tot_energia_calorie', dtype='N',name_long='Tot Calorie')
        tbl.column('tot_energia_kilojoules', dtype='N',name_long='Tot Kilojoul')
